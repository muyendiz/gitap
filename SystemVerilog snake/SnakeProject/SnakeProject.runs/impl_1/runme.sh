...
HD_PWD='C:/Users/furkanerdem/Desktop/SnakeProject/SnakeProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DisplayModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DisplayModule.tcl -notrace
