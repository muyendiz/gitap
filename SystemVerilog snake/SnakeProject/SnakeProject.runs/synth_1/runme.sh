...
HD_PWD='C:/Users/furkanerdem/Desktop/SnakeProject/SnakeProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DisplayModule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DisplayModule.tcl
